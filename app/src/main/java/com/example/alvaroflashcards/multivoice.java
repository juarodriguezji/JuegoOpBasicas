...
public class multivoice extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_multivoice);
        ...
        resmulvoic=(TextView)findViewById(R.id.mulvotxt);
        ...
        starter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                text = "Estás en el modulo de la operación multiplicación la operación que debes hacer es" + sumav + "por " + sumbv;
    ...
    private void generarNuevaMult() {
        ...
        resul = sumav*sumbv;
        text = " ¡Correcto!La siguiente operación a realizar es:" + sumav + "por " + sumbv;
        ttsManager.initQueue(text);
